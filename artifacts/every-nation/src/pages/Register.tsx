...
export default function Register() {
  ...
  return (
    <HUDOverlay pageLabel="AUTH_ENROLL">
      <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-[#020408] selection:bg-purple-500/30">
            ...
            <div className="p-8 md:p-10 flex flex-col gap-8">
              ...
              <div className="text-center flex flex-col items-center gap-4">
                <div className="relative">
                  <div className="w-16 h-16 border border-purple-500/20 flex items-center justify-center relative">
                     <div className="absolute inset-0 border border-purple-500/40 animate-[spin_10s_linear_infinite] border-t-transparent" />
                     <FaIdCard className="text-xl text-purple-400/40" />
                  </div>
                </div>
