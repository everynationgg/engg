                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.02] border border-white/10 py-5 pr-5 pl-16 tactical-input font-mono text-sm tracking-wider text-white outline-none focus:border-purple-500/50 focus:bg-purple-500/5 transition-all"
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.02] border border-white/10 py-5 pr-5 pl-16 tactical-input font-mono text-sm tracking-[0.4em] text-white outline-none focus:border-purple-500/50 focus:bg-purple-500/5 transition-all"
                      placeholder="••••••••"
                      required
                    />
                  </div>
