    ...
    >
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden" style={{ minHeight: 0 }}>
        ...
        >
          ...
          {/* Player status list (always above ACTIVE ROLES) */}
          <div className="px-4 pt-4 pb-2 border-t" style={{ borderColor: "hsl(210 30% 14%)" }}>
            <div className="text-xs tracking-widest uppercase mb-3" style={{ color: "hsl(210 30% 45%)" }}>Players</div>
            <div className="flex flex-col gap-2">
              {players.map((player) => (
                <div
                  key={player.id}
