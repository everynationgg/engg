...
export const getRecordGameResultMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordGameResult>>, TError,{data: BodyType<RecordGameRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof recordGameResult>>, TError,{data: BodyType<RecordGameRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recordGameResult>>, {data: BodyType<RecordGameRequest>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RecordGameResultMutationBody = BodyType<RecordGameRequest>
    export type RecordGameResultMutationError = ErrorType<void>

    /**
 * @summary Record game result
 */
export const useRecordGameResult = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordGameResult>>, TError,{data: BodyType<RecordGameRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof recordGameResult>>,
        TError,
        {data: BodyType<RecordGameRequest>},
        TContext
      > => {
...
export const getGetPlayerStatsQueryOptions = <TData = Awaited<ReturnType<typeof getPlayerStats>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPlayerStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
